/**
 * This component is responsible for show a emergent window with a error, this is the ModalErrorProduct.
 */
...
/**
  ...
  * with the error name.
  * @param param0 The variable sended for the productos page.
  * @returns A modal with the error.
 */
export default function ModalErrorProduct({ error }: Props) {
  const [show, setShow] = useState(false);

  useEffect(() => {
    if (error === "producto_existente") {
      setShow(true);
